<x-layouts.app.sidebar title="Data Pangkat">
    <flux:main>
<div class="space-y-6">
    <!-- Header -->
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                    @if($rank->users_count > 0) bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('ranks.destroy', $rank) }}" class="inline" 
                                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus pangkat {{ $rank->name }}?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
