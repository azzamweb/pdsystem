<x-layouts.app.sidebar title="Tambah Pangkat">
    <flux:main>
<div class="space-y-6">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Pangkat</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan pangkat baru ke sistem</p>
            </div>
        </div>
    </div>
