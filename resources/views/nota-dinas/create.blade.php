<x-layouts.app.sidebar title="Buat Nota Dinas">
    <flux:main>
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="space-y-6">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Form pembuatan Nota Dinas baru</p>
                            </div>
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('nota-dinas.store') }}" class="space-y-6">
                    @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="requesting_unit_id" id="requesting_unit_id" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        ...
                                        @foreach($units as $unit)
                                            <option value="{{ $unit->id }}" {{ old('requesting_unit_id') == $unit->id ? 'selected' : '' }}>
                                                {{ $unit->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="origin_place_id" id="origin_place_id" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        ...
                                        @foreach($orgPlaces as $place)
                                            <option value="{{ $place->id }}" {{ old('origin_place_id') == $place->id ? 'selected' : '' }}>
                                                {{ $place->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="sifat" id="sifat" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        <option value="Penting" {{ old('sifat', 'Penting') == 'Penting' ? 'selected' : '' }}>Penting</option>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="nd_date" id="nd_date" value="{{ old('nd_date', date('Y-m-d')) }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="hal" id="hal" placeholder="Masukkan hal surat" value="{{ old('hal') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        ...
                        <div class="px-6 py-4">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="number_is_manual" value="1" id="number_is_manual" {{ old('number_is_manual') ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                ...
                                <div id="manual-number-fields" class="grid grid-cols-1 md:grid-cols-2 gap-4" style="display: none;">
                                    <div>
                                        ...
                                        <input type="text" name="doc_no" id="doc_no" placeholder="Masukkan nomor dokumen" value="{{ old('doc_no') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="number_manual_reason" id="number_manual_reason" placeholder="Masukkan alasan" value="{{ old('number_manual_reason') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="px-6 py-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <div>
                                    ...
                                    <select name="trip_type" id="trip_type" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        <option value="LUAR_DAERAH" {{ old('trip_type', 'LUAR_DAERAH') == 'LUAR_DAERAH' ? 'selected' : '' }}>Luar Daerah</option>
                                        <option value="DALAM_DAERAH_GT8H" {{ old('trip_type') == 'DALAM_DAERAH_GT8H' ? 'selected' : '' }}>Dalam Daerah > 8 Jam</option>
                                        <option value="DALAM_DAERAH_LE8H" {{ old('trip_type') == 'DALAM_DAERAH_LE8H' ? 'selected' : '' }}>Dalam Daerah ≤ 8 Jam</option>
                                        <option value="DIKLAT" {{ old('trip_type') == 'DIKLAT' ? 'selected' : '' }}>Diklat</option>
                                    </select>
                        ...
                        <div class="px-6 py-4">
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="dasar" id="dasar" rows="3" placeholder="Masukkan dasar surat" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('dasar') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="maksud" id="maksud" rows="3" placeholder="Masukkan maksud surat" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('maksud') }}</textarea>
                                ...
                                <div id="participants-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    @foreach($users as $user)
                                        <div class="participant-item flex items-start p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors" data-name="{{ strtolower($user->fullNameWithTitles()) }}">
                                            <input type="checkbox" name="participants[]" value="{{ $user->id }}" id="participant-{{ $user->id }}" {{ in_array($user->id, old('participants', [])) ? 'checked' : '' }} class="mt-1 h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                            <div class="ml-3 flex-1">
                        ...
                        <div class="px-6 py-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="lampiran_count" id="lampiran_count" value="{{ old('lampiran_count', 1) }}" min="1" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <div>
                                    ...
                                    <textarea name="tembusan" id="tembusan" rows="2" placeholder="Masukkan tembusan (opsional)" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('tembusan') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" id="notes" rows="2" placeholder="Masukkan catatan (opsional)" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes') }}</textarea>
