<x-layouts.app.sidebar title="Edit Jabatan">
    <flux:main>
<div class="space-y-6">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Jabatan</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Edit data jabatan</p>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        ...
                        <select name="echelon_id" id="echelon_id" 
                            ...
                            @foreach($echelons as $echelon)
                                <option value="{{ $echelon->id }}" {{ old('echelon_id', $position->echelon_id) == $echelon->id ? 'selected' : '' }}>
