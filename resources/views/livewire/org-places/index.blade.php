<div>
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <!-- Search -->
            <div class="mb-4">
                <input wire:model.live="search" type="text" placeholder="Cari kedudukan organisasi..." 
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($orgPlaces as $orgPlace)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                        {{ $orgPlace->name }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">
                                        {{ $orgPlace->location_info }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($orgPlace->is_org_headquarter)
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                        @if($search)
                                            Tidak ada kedudukan organisasi yang ditemukan dengan kata kunci "{{ $search }}"
                                        @else
                                            Belum ada data kedudukan organisasi
                                        @endif
                                    </td>
                                </tr>
                            @endforelse
