<div class="space-y-6">
    ...
    <div>
        ...
        <flux:text class="text-base mb-4">📊 Statistik Utama</flux:text>
    ...
    <div>
        <flux:text class="text-base mb-4">📋 Status Dokumen</flux:text>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-zinc-100 rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <flux:text class="text-base">🕒 Aktivitas Terbaru</flux:text>
