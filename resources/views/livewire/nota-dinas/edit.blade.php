<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('documents', ['nota_dinas_id' => $notaDinas->id]) }}"
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form wire:submit="save" class="space-y-6 p-6">
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('documents', ['nota_dinas_id' => $notaDinas->id]) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">Batal</a>
            ...
            if (Array.isArray(details)) {
                details.forEach(ov => {
                    ...
                    const hal = ov.hal || 'N/A';
                        ...
                        console.log('Processing overlap (EDIT):', {
                            user: user,
                            docNo: docNo,
                            unit: unit,
                            hal: hal,
