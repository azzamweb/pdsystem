<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Referensi Transportasi Dalam Provinsi</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambah referensi tarif transportasi darat umum dalam provinsi</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form wire:submit="save" class="space-y-6 p-6">
            ...
            <!-- Destination City -->
            <div>
                <label for="destination_city_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Kota Tujuan <span class="text-red-500">*</span>
                </label>
                <select
                    wire:model="destination_city_id"
