        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="flex justify-between items-center mb-6">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('documents') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded flex items-center">
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-blue-900 dark:text-blue-100">{{ $sppd->originPlace->name ?? 'N/A' }} → {{ $sppd->destinationCity->name ?? 'N/A' }}</p>
                    </div>
                    <div class="space-y-1">
