                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                                    {{ $spt->notaDinas->doc_date ? \Carbon\Carbon::parse($spt->notaDinas->doc_date)->locale('id')->translatedFormat('d F Y') : '-' }}
                                                </p>
                                            </div>
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                                    {{ $spt->doc_date ? \Carbon\Carbon::parse($spt->doc_date)->locale('id')->translatedFormat('d F Y') : '-' }}
                                                </p>
                                            </div>
                                            <div class="space-y-1">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">3. SPPD:</span>
                                                <p class="text-gray-900 dark:text-white font-mono">{{ $spt->sppds->first()?->doc_no ?? '-' }}</p>
                                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                                    {{ $spt->sppds->first()?->doc_date ? \Carbon\Carbon::parse($spt->sppds->first()->doc_date)->locale('id')->translatedFormat('d F Y') : '-' }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->sifat ?? '-' }}</p>
                                            </div>
                                            <div class="space-y-1">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Lampiran:</span>
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->lampiran_count ?? 0 }} lembar</p>
                                            </div>
                                            <div class="space-y-1">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->tembusan ?? '-' }}</p>
                                            </div>
                                            <div class="space-y-1">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Tempat Asal:</span>
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->originPlace->name ?? '-' }}</p>
                                            </div>
                                            <div class="space-y-1">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                                    ({{ $spt->notaDinas->days_count ?? ($spt->notaDinas->start_date && $spt->notaDinas->end_date ? \Carbon\Carbon::parse($spt->notaDinas->start_date)->diffInDays(\Carbon\Carbon::parse($spt->notaDinas->end_date)) + 1 : 0) }} hari)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->dasar ?? '-' }}</p>
                                            </div>
                                            <div class="space-y-1">
                                                <span class="font-medium text-gray-700 dark:text-gray-300">Maksud:</span>
                                                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->maksud ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div>
                                         ...
                                         <div class="flex flex-wrap gap-2">
                                             @foreach($spt->notaDinas->getSortedParticipants() as $participant)
