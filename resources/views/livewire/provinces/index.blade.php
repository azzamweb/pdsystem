    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Provinsi</h1>
                            ...
                            @forelse($provinces as $province)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                            @if($province->cities_count > 0) bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300
                                            @else bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 @endif">
                                            {{ $province->cities_count }} Kota/Kabupaten
                                        </span>
                                    </td>
                                ...
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <button 
                                        ...
                                        wire:confirm="Apakah Anda yakin ingin menghapus provinsi {{ $province->name }}?"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                    @if($search)
                                        Tidak ada provinsi yang ditemukan dengan kata kunci "{{ $search }}"
                                    @else
