    ...
    <div class="min-h-screen dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
            ...
            @if($selectedNotaDinasId)
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-green-200 dark:bg-green-800">
                                <div class="flex justify-between items-center">
                                    ...
                                    {{-- <button 
                                        onclick="window.location.href='{{ route('sppd.create', ['spt_id' => $selectedSptId]) }}'"
                ...
                <!-- Kwitansi Section - Only show if SPT is selected -->
                @if($selectedSptId && $selectedSpt)
                    <!-- Kolom 2: Kwitansi -->
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="p-4">
                                <div class="space-y-3">
                                    <!-- Kwitansi Status -->
                                    @php
                                        $receipts = $selectedSptId ? \App\Models\Receipt::whereHas('sppd', function($query) use ($selectedSptId) {
                                            $query->where('spt_id', $selectedSptId);
                                        })->get() : collect();
                                    @endphp
                                    ...
                                    @else
                                        <div class="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md">
                                            ...
                                            <p class="text-xs text-yellow-700 dark:text-yellow-300 mt-1">Buat kwitansi untuk SPPD yang sudah ada</p>
                                        </div>
                ...
                @else
                    <!-- Placeholder when no SPT selected for Kwitansi -->
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="p-8 text-center text-gray-500 dark:text-gray-400">
                                <svg class="w-12 h-12 mx-auto mb-4 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p>Pilih SPT untuk mengelola kwitansi</p>
                            </div>
                        </div>
                    </div>
                @endif
