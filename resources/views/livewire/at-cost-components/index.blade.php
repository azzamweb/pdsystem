<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Data Komponen At-Cost</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola komponen biaya at-cost (Ro-Ro, Parkir Inap, Tol, Rapid Test, Taksi)</p>
        </div>
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('at-cost-components.create') }}"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('at-cost-components.edit', $component) }}"
                                    ...
                                    <button
                                        wire:click="delete({{ $component }})"
                                        wire:confirm="Apakah Anda yakin ingin menghapus komponen {{ $component->display_name }}?"
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                @if($search)
                                    Tidak ada komponen at-cost yang ditemukan dengan kata kunci "{{ $search }}"
                                @else
                                    Belum ada data komponen at-cost
                                @endif
                            </td>
                        </tr>
                    @endforelse
