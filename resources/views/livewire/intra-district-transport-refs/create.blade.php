<div>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Tambah Referensi Transportasi Dalam Kecamatan</h2>
                <p class="mt-1 text-sm text-gray-600">
                    Tambah referensi tarif transportasi dari tempat kerja ke ibukota kecamatan
                </p>
            </div>
