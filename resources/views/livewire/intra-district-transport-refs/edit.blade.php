<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Referensi Transportasi Dalam Kecamatan</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Edit referensi tarif transportasi dari tempat kerja ke ibukota kecamatan</p>
        </div>
