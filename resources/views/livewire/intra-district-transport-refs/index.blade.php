<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Referensi Transportasi Dalam Kecamatan</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola referensi tarif transportasi dari tempat kerja ke ibukota kecamatan</p>
        </div>
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('intra-district-transport-refs.create') }}" 
    ...
    <div class="flex items-center space-x-4">
        <div class="flex-1 relative">
            ...
            <input 
                ...
                placeholder="Cari berdasarkan tempat kerja atau kecamatan..."
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        @if($transportRef->originPlace && $transportRef->originPlace->city)
                                            {{ $transportRef->originPlace->city->name }}, {{ $transportRef->originPlace->city->province->name }}
                                        @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('intra-district-transport-refs.edit', $transportRef) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    @else
                                        Belum ada data referensi transportasi dalam kecamatan
                                    @endif
                                </td>
                            </tr>
                        @endforelse
