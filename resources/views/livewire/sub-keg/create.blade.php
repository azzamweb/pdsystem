        ...
        <div class="px-6 py-6">
            <form wire:submit="store" class="space-y-6">
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    <h4 class="text-sm font-medium text-blue-800 dark:text-blue-200 mb-2">Contoh Sub Kegiatan:</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <strong class="text-blue-700 dark:text-blue-300">Kode & Nama:</strong>
                            <ul class="text-blue-600 dark:text-blue-400 ml-4">
                                <li>• 5.02.02.2.01.0001 - Koordinasi dan Penyusunan KUA dan PPAS</li>
                                <li>• 5.02.02.2.02.0001 - Koordinasi, Penyusunan dan Verifikasi RKA SKPD</li>
