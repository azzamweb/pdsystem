<x-layouts.app.sidebar title="Tambah Unit">
    <flux:main>
<div class="space-y-6">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Unit</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan unit/bidang/bagian baru ke sistem</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="parent_id" id="parent_id" 
                            ...
                            @foreach($units as $unitOption)
                                <option value="{{ $unitOption->id }}" {{ old('parent_id') == $unitOption->id ? 'selected' : '' }}>
