<x-layouts.app.sidebar title="Data Kecamatan">
    <flux:main>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('districts.destroy', $district) }}" class="inline" 
                                              onsubmit="return confirm('Apakah Anda yakin ingin menghapus kecamatan {{ $district->name }}?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
