<x-layouts.app.sidebar title="Edit Kota/Kabupaten">
    <flux:main>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="kemendagri_code" id="kemendagri_code" 
                                   value="{{ old('kemendagri_code', $city->kemendagri_code) }}"
                        ...
                        <div>
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="KAB" {{ old('type', $city->type) == 'KAB' ? 'selected' : '' }}>Kabupaten</option>
                                <option value="KOTA" {{ old('type', $city->type) == 'KOTA' ? 'selected' : '' }}>Kota</option>
                            </select>
                            @error('type') 
                                <span class="text-red-500 text-sm">{{ $message }}</span> 
                            @enderror
