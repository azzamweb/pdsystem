...
/**
 * Script untuk test upload via web interface
 */
...
echo "=== TEST WEB INTERFACE UPLOAD ===\n\n";
...
if (empty($logoFiles)) {
    ...
    $testLogoPath = $logosPath . '/test_web_logo_' . time() . '.png';
...
// 7. Test web interface access
echo "7. TESTING WEB INTERFACE ACCESS:\n";
echo "===============================\n";

try {
    // Test if organization settings page is accessible
    $orgSettingsUrl = url('/settings/organization');
    echo "Organization settings URL: $orgSettingsUrl\n";
    
    // Test if logo file is accessible via web
    $logoUrl = \Storage::disk('public')->url($logoPath);
    echo "Logo web URL: $logoUrl\n";
    
    // Test if storage symlink is working
    ...
    echo "✗ Web interface access test failed: " . $e->getMessage() . "\n";
}
...
echo "\n=== WEB INTERFACE UPLOAD TEST COMPLETE ===\n";
echo "\nNext steps:\n";
echo "1. Access /settings/organization in your browser\n";
echo "2. Try uploading a logo file through the web interface\n";
echo "3. Check if the logo is displayed in the sidebar and welcome page\n";
echo "4. Check browser console for any JavaScript errors\n";
echo "5. Check application logs for any errors during upload\n";
